...
from electrumfair.util import UserCancelled, InvalidPassword
from electrumfair.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET
...
MSG_GENERATING_WAIT = _("ElectrumFair is generating your addresses, please wait...")
