...
Section
  ...
  WriteRegStr HKCU "Software\Classes\faircoin" "DefaultIcon" "$\"$INSTDIR\electrum.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\faircoin\shell\open\command" "" "$\"$INSTDIR\electrum.exe$\" $\"%1$\""
