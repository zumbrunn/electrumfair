...
<<<<<<< HEAD:electrum/plugins/labels/qt.py
...
from electrumfair.gui.qt import EnterButton
from electrumfair.gui.qt.util import ThreadedButton, Buttons
from electrumfair.gui.qt.util import WindowModalDialog, OkButton
>>>>>>> 3.2.3-fc:electrumfair/plugins/labels/qt.py
