...
from electrumfair.plugin import hook
from electrumfair.i18n import _
from electrumfair.util import make_dir, InvalidPassword, UserCancelled
from electrumfair.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                  WindowModalDialog, Buttons, CloseButton, OkButton)
from electrumfair.gui.qt.qrtextedit import ScanQRTextEdit
from electrumfair.gui.qt.main_window import StatusBarButton
...
class Plugin(RevealerPlugin):
    ...
    def __init__(self, parent, config, name):
        ...
        self.base_dir = os.path.join(config.electrumfair_path(), 'revealer')
