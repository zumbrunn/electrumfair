...
from electrumfair.network import Network
from electrumfair.util import print_msg, create_and_start_event_loop
from electrumfair.synchronizer import SynchronizerBase

try:
    addr = sys.argv[1]
except Exception:
    print("usage: watch_address <FairCoin_address>")
    sys.exit(1)
